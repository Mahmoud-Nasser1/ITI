...
//Built-in/Pre-defined Delegate
//1. Func<> -> can have zero or more (up to 16) input parameters,
//            and must have one output parameter.
//string Add(double firstNo, double secondNo) => (firstNo + secondNo).ToString("N2");
//string Subtract(double firstNo, double secondNo) => (firstNo - secondNo).ToString("N2");
//string Multiply(double firstNo, double secondNo) => (firstNo * secondNo).ToString("N2");
//string Divide(double firstNo, double secondNo) => (firstNo / secondNo).ToString("N2");
...
//Func<double, double, string> calculateTwoNumbers;

//calculateTwoNumbers = Add;
//Console.WriteLine("calculateTwoNumbers(no1, no2) [Add]\t\t: " + calculateTwoNumbers(no1, no2));
...
////2. Action<> -> 1 to 16 input parameters. Its return type if void.
//void PrintPaymentReceipt(string name, decimal amount)
//{
...
//void PrintReceipt(string name, decimal amount)
//{
...
//Action<string, decimal> printAnyReceipt;
//printAnyReceipt = PrintPaymentReceipt;
//printAnyReceipt("Ahmed Omar", 17500);

//Console.WriteLine();

//printAnyReceipt = PrintReceipt;
//printAnyReceipt("Wael Mahmoud", 22400);



//===========================================================================================

//3. Predicate<> -> Takes/receives 1 parameter and returns bool
//bool IsLegalHiringAge(DateTime birthDate)
//{
//    return birthDate.AddYears(18) <= DateTime.Now;
//}

//bool IsAcceptedSchoolAge(DateTime birthDate)
//{
//    return birthDate.AddYears(6) <= DateTime.Now;
//}

//Predicate<DateTime> isAllowedAge;
//isAllowedAge = IsLegalHiringAge;
//Console.WriteLine("isAllowedAge(new DateTime(2008, 8, 15)) [IsLegalHiringAge]\t: " + isAllowedAge(new DateTime(2008, 8, 15)));
//Console.WriteLine("isAllowedAge(new DateTime(2008, 8, 25)) [IsLegalHiringAge]\t: " + isAllowedAge(new DateTime(2008, 8, 25)));

//Console.WriteLine();

//isAllowedAge = IsAcceptedSchoolAge;
//Console.WriteLine("isAllowedAge(new DateTime(2020, 8, 14)) [IsAcceptedSchoolAge]\t: " + isAllowedAge(new DateTime(2020, 8, 14)));
//Console.WriteLine("isAllowedAge(new DateTime(2020, 8, 24)) [IsAcceptedSchoolAge]\t: " + isAllowedAge(new DateTime(2020, 8, 24)));
...
//intBox1.Value = 275;
//Console.Write("intBox1.Display()\t: ");
//intBox1.Display();

////Box<int> box1 = new Box<int>();
//Box<int> box1OfInt = new();
//box1OfInt.Value = 275;
//Console.Write("box1OfInt.Display()\t: ");
//box1OfInt.Display();


//Box<int> boxOfInt2 = new(432);
//Console.Write("boxOfInt2.Display()\t: ");
//boxOfInt2.Display();


//===========================================================================================

////Dictionary (Key-value pair or kvp)
//Dictionary<int, string> branches = new()
//{
//    {1010, "Kuwait"},
//    {1020, "Bahrain"},
//    {2010, "Thailand"},
...
////shoppingCart1.products[0] = "A 32";
//shoppingCart1[0] = "A 32";
//shoppingCart1[1] = "Tablet Abc7";
//shoppingCart1[2] = "Def";
//shoppingCart1[3] = "Ghi";

////Console.WriteLine(shoppingCart1.products[0]);
//Console.WriteLine("shoppingCart1[0]: " + shoppingCart1[0]);
//Console.WriteLine("shoppingCart1[1]: " + shoppingCart1[1]);
//Console.WriteLine("shoppingCart1[2]: " + shoppingCart1[2]);
//Console.WriteLine("shoppingCart1[3]: " + shoppingCart1[3]);

//Console.WriteLine("\n[[[for (int i = 0; i < shoppingCart1.Count; i++)]]]");
//for (int i = 0; i < shoppingCart1.Count; i++)
//{
//    Console.WriteLine("shoppingCart1[" + i + "]: " + shoppingCart1[i]);
//}
